...
SQL;
	...
	while ($stmt->fetch()){
		echo "<tr>";
		echo "<td><a href=\"read.php?id=".$id."&type=4&acl=Q\">Project</a></td>";
		echo "<td>".$id."</td>";
		echo "<td>".$name."</td>";
		echo "<td>".$last."</td>";
...
SQL;
	...
	while ($stmt->fetch()){
		echo "<tr>";
		echo "<td><a href=\"read.php?id=".$id."&type=6&acl=Q\">Payment</a></td>";
		echo "<td>".$id."</td>";
		echo "<td>".$name."</td>";
		echo "<td>".$last."</td>";
...
SQL;
	...
	while ($stmt->fetch()){
		echo "<tr>";
		echo "<td><a href=\"read.php?id=".$id."&type=7&acl=Q\">Quotation</a></td>";
		echo "<td>".$id."</td>";
		echo "<td>".$name."</td>";
		echo "<td>".$last."</td>";
...
SQL;
	...
	while ($stmt->fetch()){
		echo "<tr>";
		echo "<td><a href=\"read.php?id=".$id."&type=8&acl=Q\">Invoice</a></td>";
		echo "<td>".$id."</td>";
		echo "<td>".$name."</td>";
		echo "<td>".$last."</td>";
...
SQL;
	...
	while ($stmt->fetch()){
		echo "<tr>";
		echo "<td><a href=\"read.php?id=".$id."&type=9&acl=Q\">Tax Invoice</a></td>";
		echo "<td>".$id."</td>";
		echo "<td>".$name."</td>";
		echo "<td>".$last."</td>";
